...
#ESPNDF['PosAndRank 161-240'] = ESPNDF['PosAndRank 161-240'].str.split('(').str[1]
...
ESPNDF = NewESPN
#ESPNDF = ESPNDF.drop(ESPNDF.index[0])
...
#Top300 = ESPNDF[['OVR 241-300','Players 241-300','PosAndRank 241-300']].copy()
...
QBRanks.to_csv('QBRanks.csv', index = False)
RBRanks.to_csv('RBRanks.csv', index = False)
WRRanks.to_csv('WRRanks.csv', index = False)
TERanks.to_csv('TERanks.csv', index = False)
ESPNRanks.to_csv('OverallRanks.csv', index = False)
